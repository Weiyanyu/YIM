 ...
 **/
public class SingleMessageResponseHandler extends SimpleChannelInboundHandler<SingleMessageResponseAbstractPacket> {

    @Override
    protected void channelRead0(ChannelHandlerContext ctx, SingleMessageResponseAbstractPacket singleMessageResponsePacket) throws Exception {
        //仅仅简单的打印消息即可
